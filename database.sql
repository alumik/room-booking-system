...
INSERT INTO `admin` (admin_id, admin_name, auth_key, password_hash, email, created_at, updated_at, super_admin,
                     web_admin, student_admin, room_admin)
VALUES ('0000000', 'admin', 'hj8GOGo8sW_paLcBy18BBKh7XCXAX9nz',
        '$2y$13$jAbTuqXYhM.ij1bky2yYVePUbeL8gwlUhjBVTf3I46shMcNH0HMzq', 'admin@example.com', 1530690128, 1530690224, 1,
        0, 0,
        0);

INSERT INTO `user` (student_id, username, auth_key, password_hash, password_reset_token, email, status, created_at,
                    updated_at)
...
VALUES ('manageAdmin', 2, '修改管理员', NULL, NULL, 1528614184, 1528614184),
...
VALUES ('superAdmin', 'manageAdmin'),
       ('webAdmin', 'manageAdmin'),
       ('superAdmin', 'managePermission'),
       ('roomAdmin', 'manageRoom'),
       ('superAdmin', 'manageRoom'),
       ('studentAdmin', 'manageStudent'),
       ('superAdmin', 'manageStudent'),
       ('superAdmin', 'viewAdminList'),
       ('webAdmin', 'viewAdminList'),
       ('roomAdmin', 'viewStudentList'),
       ('studentAdmin', 'viewStudentList'),
       ('superAdmin', 'viewStudentList');
